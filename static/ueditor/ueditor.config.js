...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"php/controller.php"             //图片上传提交地址
        ...
        , toolbars:[
            ['fullscreen', 'source', 'autotypeset', 'bold', 'italic', 'blockquote', 'forecolor',
			 'backcolor', 'fontsize', 'fontFamily', 'strikethrough', 'underline', 'formatmatch',
			 'horizontal', 'indent', 'insertcode', 'image', 'justify', 'link', 'music','removeformat',
			 'isertimage','insertvideo','imagenone','insertimage', '|',
